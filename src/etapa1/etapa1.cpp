...
void etapa1::run() {
    std::filesystem::create_directory("../out/etapa1");
    std::ifstream instrucoes("../progs/etapa1/programa_etapa1.txt");
    std::ofstream log("../out/etapa1/log.txt");
    std::ofstream saida("../out/etapa1/saida_etapa1.txt");
